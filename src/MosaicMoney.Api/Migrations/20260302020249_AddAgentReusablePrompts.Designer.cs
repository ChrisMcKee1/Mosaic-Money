...
namespace MosaicMoney.Api.Migrations
{
    ...
    [Migration("20260302020249_AddAgentReusablePrompts")]
    partial class AddAgentReusablePrompts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MosaicMoney.Api.Domain.Ledger.AgentReusablePrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdUserId");

                    b.HasIndex("StableKey")
                        .IsUnique()
                        .HasFilter("\"Scope\" = 0 AND \"StableKey\" IS NOT NULL");

                    b.HasIndex("HouseholdId", "HouseholdUserId", "Title")
                        .IsUnique()
                        .HasFilter("\"Scope\" = 1 AND \"IsArchived\" = FALSE");

                    b.HasIndex("Scope", "IsArchived", "DisplayOrder", "Title");

                    b.HasIndex("HouseholdId", "HouseholdUserId", "IsFavorite", "LastUsedAtUtc", "LastModifiedAtUtc")
                        .HasFilter("\"Scope\" = 1 AND \"IsArchived\" = FALSE");

                    b.ToTable("AgentReusablePrompts", t =>
                        {
                            t.HasCheckConstraint("CK_AgentReusablePrompt_ArchiveAuditConsistency", "(\"IsArchived\" = FALSE AND \"ArchivedAtUtc\" IS NULL) OR (\"IsArchived\" = TRUE AND \"ArchivedAtUtc\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_DisplayOrderRange", "\"DisplayOrder\" >= 0");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_FavoriteOnlyForUserScope", "(\"Scope\" = 1) OR (\"IsFavorite\" = FALSE)");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_PromptTextRequired", "LENGTH(TRIM(\"PromptText\")) > 0");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_ScopeOwnershipConsistency", "(\"Scope\" = 0 AND \"HouseholdId\" IS NULL AND \"HouseholdUserId\" IS NULL AND \"IsFavorite\" = FALSE) OR (\"Scope\" = 1 AND \"HouseholdId\" IS NOT NULL AND \"HouseholdUserId\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_ScopeRange", "\"Scope\" IN (0, 1)");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_StableKeyForPlatform", "(\"Scope\" = 0 AND \"StableKey\" IS NOT NULL AND LENGTH(TRIM(\"StableKey\")) > 0) OR (\"Scope\" = 1)");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_TitleRequired", "LENGTH(TRIM(\"Title\")) > 0");

                            t.HasCheckConstraint("CK_AgentReusablePrompt_UsageCountRange", "\"UsageCount\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("MosaicMoney.Api.Domain.Ledger.AgentReusablePrompt", b =>
                {
                    b.HasOne("MosaicMoney.Api.Domain.Ledger.Household", "Household")
                        .WithMany("AgentReusablePrompts")
                        .HasForeignKey("HouseholdId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MosaicMoney.Api.Domain.Ledger.HouseholdUser", "HouseholdUser")
                        .WithMany("SavedAgentPrompts")
                        .HasForeignKey("HouseholdUserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("MosaicMoney.Api.Domain.Ledger.Household", b =>
                {
                    ...
                    b.Navigation("AgentReusablePrompts");
            ...
            modelBuilder.Entity("MosaicMoney.Api.Domain.Ledger.HouseholdUser", b =>
                {
                    ...
                    b.Navigation("SavedAgentPrompts");
                });

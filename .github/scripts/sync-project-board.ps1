...
$issues = @(
    ...
    @{ num=134; nid="I_kwDORVI-G87ukfAv"; status="Done" } # MM-FE-27
    @{ num=137; nid="I_kwDORVI-G87ukfBN"; status="Done" } # MM-AI-14
    ...
    @{ num=150; nid="I_kwDORVI-G87unDx4"; status="In Review" } # AP0-AI-01

...
$issues = @(
    ...
    @{ num=49; nid="I_kwDORVI-G87tOlqE"; status="Not Started" } # MM-AI-08
    @{ num=50; nid="I_kwDORVI-G87tOlr1"; status="Not Started" } # MM-AI-09
    ...
    @{ num=60; nid="I_kwDORVI-G87tOmnF"; status="Not Started" } # MM-MOB-07.3

...
The Aspire MCP server provides two tools for integration discovery — these work on modern CLI versions (including 13.3 daily) and do **not** require a running AppHost.

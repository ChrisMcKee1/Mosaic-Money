...
- `foundry-mcp-iq-bootstrap-runbook.md`: minimal v1 Foundry agent bootstrap runbook (model + system prompt), plus tracked follow-up items for MCP tool integration.

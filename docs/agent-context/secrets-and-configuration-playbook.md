...
## Agent Loading
- Load when: adding/changing configuration keys, secrets, AppHost parameters, or runtime injection contracts.
...
11. `Parameters:foundry-agent-api-key` (secret; optional when `UseDefaultAzureCredential=true`, required for key-based auth)
...
23. `AiWorkflow:Agent:Foundry:McpDatabaseToolProjectConnectionId`
24. `AiWorkflow:Agent:Foundry:McpDatabaseAllowedToolsCsv`
25. `AiWorkflow:Agent:Foundry:McpDatabaseRequireApproval`
26. `AiWorkflow:Agent:Foundry:McpApiToolName`
27. `AiWorkflow:Agent:Foundry:McpApiToolEndpoint`
28. `AiWorkflow:Agent:Foundry:McpApiToolProjectConnectionId`
29. `AiWorkflow:Agent:Foundry:McpApiAllowedToolsCsv`
30. `AiWorkflow:Agent:Foundry:McpApiRequireApproval`
31. `AiWorkflow:Agent:Foundry:KnowledgeBaseMcpServerLabel`
32. `AiWorkflow:Agent:Foundry:KnowledgeBaseMcpEndpoint`
33. `AiWorkflow:Agent:Foundry:KnowledgeBaseProjectConnectionId`
34. `AiWorkflow:Agent:Foundry:KnowledgeBaseAllowedToolsCsv`
...
9. `AiWorkflow:Agent:Foundry:McpDatabaseToolProjectConnectionId`
10. `AiWorkflow:Agent:Foundry:McpDatabaseAllowedToolsCsv`
11. `AiWorkflow:Agent:Foundry:McpDatabaseRequireApproval`
12. `AiWorkflow:Agent:Foundry:McpApiToolName`
13. `AiWorkflow:Agent:Foundry:McpApiToolEndpoint`
14. `AiWorkflow:Agent:Foundry:McpApiToolProjectConnectionId`
15. `AiWorkflow:Agent:Foundry:McpApiAllowedToolsCsv`
16. `AiWorkflow:Agent:Foundry:McpApiRequireApproval`
17. `AiWorkflow:Agent:Foundry:KnowledgeBaseMcpServerLabel`
18. `AiWorkflow:Agent:Foundry:KnowledgeBaseMcpEndpoint`
19. `AiWorkflow:Agent:Foundry:KnowledgeBaseProjectConnectionId`
20. `AiWorkflow:Agent:Foundry:KnowledgeBaseAllowedToolsCsv`
21. `AiWorkflow:Agent:Foundry:KnowledgeBaseRequireApproval`
22. `AiWorkflow:Agent:Foundry:KnowledgeSourceUrl`
23. `AiWorkflow:Agent:Foundry:ApiVersion`
...
# Optional when using Entra/DefaultAzureCredential auth; required for key-based auth.
...
- Use `AiWorkflow:Agent:Foundry:ApiVersion=v1` as the default unless tenant compatibility requires a preview fallback.

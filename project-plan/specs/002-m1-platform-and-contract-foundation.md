...
|---|---|---|---|---|
| MM-ASP-01 | Bootstrap Aspire topology skeleton | None | AppHost, ServiceDefaults, API, Worker, Web resources build and run. | In Progress |
| MM-ASP-02 | Configure JS hosting API in AppHost | MM-ASP-01 | `AddJavaScriptApp` or equivalent modern API with external endpoint exposure. | Not Started |
...
| MM-FE-01 | Next.js App Router foundation | MM-ASP-02 | Web shell foundation with responsive and accessible primitives. | Not Started |
